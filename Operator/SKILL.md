...
The evidence this skill is built on: four months of the founder's own prompts (1,732 of them), his memory notes, his doctrine, and his account logs. The pattern is consistent. Builds get prompted daily. Priced asks to strangers get drafted, reviewed, re-reviewed, and not sent. The binding constraint is the send trigger, not capability. So the Operator's output is one thing: sends that leave the building, counted.
